  ...
  return (
    <section className="max-sm:px-1 min-h-screen " >
      <div className="flex flex-col items-center">    
        {contents.length === 0?(
          <div className="flex flex-col items-center justify-center min-h-screen border-2 border-amber-950">
          ...
          i === 0?(
            ...
            {i === 1 && ( // ← only renders once, before the first "other" post            
              ...
              <div key={i} className="w-full md:w-3xl lg:w-4xl  p-5 mt-10 flex flex-col gap-2">
                <div className="flex justify-between cursor-pointer max-sm:flex-wrap ">
